...
public class RaterDialog extends DialogFragment {
    ...
    public interface SaveRatingListener{
        void didFinishGroceryRaterDialog(float rating);
    }
    ...
    {
        final View view = inflater.inflate(R.layout.dialog_groceryrater, container);
        getDialog().setTitle("Rate Grocery");
    ...
    private void saveRating(float rating) {
        ...
        activity.didFinishGroceryRaterDialog(rating);

        ...
        btnSave.setOnClickListener(view -> {
            if(groceryId == -1)
            {
                ...
                RestClient.execPutRequest(currentGrocery,
                        ...
                        GroceryMapActivity.this,
                        result -> Log.d(TAG, "onSuccess: Post" + currentGrocery.getId()));
            }
        });
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                if (ContextCompat.checkSelfPermission(GroceryMapActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(GroceryMapActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION)) {
                        ...
                        Snackbar.make(findViewById(R.id.activity_grocery_map), "MyGroceryList requires this permission to locate " + "your Grocerys", Snackbar.LENGTH_INDEFINITE).setAction("OK",
                                        view -> ActivityCompat.requestPermissions(GroceryMapActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION},PERMISSION_REQUEST_LOCATION))
                                .show();
